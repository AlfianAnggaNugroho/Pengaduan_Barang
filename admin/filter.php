      ...
      <div class="card-body">
        <form action="report-harian.php" method="POST">
          <div class="col-md-12">
            ...
            <div class="row">
              <div class="col-md-4">
                ...
                <div class="input-group mb-3">
                  ...
                  <input name="tgl1" id="datepicker1" class="form-control" style="cursor: pointer;"
              ...
              <div class="col-md-4">
                ...
                <div class="input-group mb-3">
                  ...
                  <input name="tgl2" id="datepicker2" class="form-control" style="cursor: pointer;"
            ...
            <div class="row">
              <div class="col-md-6">
                <button type="submit" value="searchHari" class="btn btn-outline-success mr-2"
                  style="width: 100px;"><span class="fas fa-search mr-2"></span>Search</button>
                <button type="reset" class="btn btn-outline-danger" style="width: 100px;"><span
                    class="fas fa-times mr-2"></span>Reset</button>
              </div>
            </div>
          </div>
        </form>
      ...
      <div class="card-body">
        <form action="report-bulanan.php" method="POST">
          <div class="col-md-12" id="month">
            ...
            <div class="row">
              <div class="col-md-6">
                <button type="submit" value="searchBulan" class="btn btn-outline-success mr-2"
                  style="width: 100px;"><span class="fas fa-search mr-2"></span>Search</button>
                <button type="reset" class="btn btn-outline-danger" style="width: 100px;"><span
                    class="fas fa-times mr-2"></span>Reset</button>
              </div>
      ...
      <div class="card-body">
        <form action="report-tahunan.php" method="POST">
          <div class="col-md-12">
            ...
            <div class="row">
              <div class="col-md-6">
                <button type="submit" value="searchTahun" class="btn btn-outline-success mr-2"
                  style="width: 100px;"><span class="fas fa-search mr-2"></span>Search</button>
                <button type="reset" class="btn btn-outline-danger" style="width: 100px;"><span
                    class="fas fa-times mr-2"></span>Reset</button>
              </div>
