...
<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <!-- /.card -->
    <!-- Default box -->
    <div class="card mb-auto" style="background-color: rgba(0, 128, 0, 0.2);">
      <div class="card-header">
          ...
          <table class="table-hover" id="table3" width="100%">
            ...
            <tbody align="center">
              ...
              <tr>
                ...
                <td><?= $d['maskapai']; ?></td>
                <td><?= $d['tgl_lapor']; ?></td>
                <td><a href="detail-pengaduan.php?id=<?= $d['id']; ?>" class="btn btn-sm btn-info mr-2"
                    style="font-size: 15px;"><i class="fas fa-search"></i></a>
                  <a href="delete-pengaduan.php?id=<?= $d['id']; ?>" class="btn btn-sm btn-danger mr-2"
                    style="font-size: 15px;"><i class="fas fa-trash-alt"></i></a>
                  <?php
                // Tampilkan tombol cetak-bukti hanya jika keterangan = 'Sudah Diambil'
                if ($d['keterangan'] == 'Sudah Diambil') :
                ?>
                  <a href="cetak-bukti.php?id=<?= $d['id']; ?>" target="_blank" class="btn btn-sm btn-warning"
