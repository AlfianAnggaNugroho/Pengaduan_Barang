    ...
    if (mysqli_num_rows($result) === 1) {
        ...
        if (password_verify($password, $row['password'])) {
            if ($row['status'] == 1) {
                $_SESSION["login"] = true;
                $_SESSION["login"] = $row;
                echo "<script>alert('Login Success! (Findmine)'); window.location='../admin/index.php';</script>";
                exit;
            } else {
...
<body>
  <div class="container">
    <div class="row content">
      ...
      <div class="col-md-6">
        <a class="btn logo" href="../index.php">Findmine</a>
        <img src="../assets/dist/img/IconAngkasa.png" width="35" height="35">
        <p class="lead">Sistem pengajuan barang hilang</p>
        ...
        <br>
        <center>
          <p>Repost by <a href='#' title='#' target='_blank'><b>Angkasa Pura II (Findmine)</b></a></p>
        </center>
